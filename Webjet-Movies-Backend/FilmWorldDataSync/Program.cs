...
{
    var filmWorldConfigOption = hostconfig.Configuration
   .GetSection(nameof(FilmWorldConfigurationOption))
   .Get<FilmWorldConfigurationOption>();

    services.Configure<FilmWorldConfigurationOption>(hostconfig.Configuration.GetSection(nameof(FilmWorldConfigurationOption)));
    ...
    // It is just cleaner
    services.AddServices(filmWorldConfigOption, redisConfigOption);
});
